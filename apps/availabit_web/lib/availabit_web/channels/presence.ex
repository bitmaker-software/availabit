defmodule AvailabitWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule AvailabitWeb.MyChannel do
        use AvailabitWebWeb, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :availabit,
                        pubsub_server: AvailabitWeb.PubSub
end
